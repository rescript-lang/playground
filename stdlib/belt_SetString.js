'use strict';
define(["exports", "./belt_internalAVLset.js", "./belt_internalSetString.js"],
  function(exports, Belt_internalAVLset, Belt_internalSetString){
    'use strict';
    function add(t, x) {
      if (t !== null) {
        var v = t.value;
    ...
    var ofArray = Belt_internalSetString.ofArray;
