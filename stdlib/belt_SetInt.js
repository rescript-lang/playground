'use strict';
define(["exports", "./belt_internalAVLset.js", "./belt_internalSetInt.js"],
  function(exports, Belt_internalAVLset, Belt_internalSetInt){
    'use strict';
    function add(t, x) {
      if (t !== null) {
        var v = t.value;
    ...
    var ofArray = Belt_internalSetInt.ofArray;
