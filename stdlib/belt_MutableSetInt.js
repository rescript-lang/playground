'use strict';
define(["exports", "./curry.js", "./belt_SortArrayInt.js", "./belt_internalAVLset.js", "./belt_internalSetInt.js"],
  function(exports, Curry, Belt_SortArrayInt, Belt_internalAVLset, Belt_internalSetInt){
    'use strict';
    ...
    function ofArray(xs) {
      return {
              data: Belt_internalSetInt.ofArray(xs)
            };
    }
